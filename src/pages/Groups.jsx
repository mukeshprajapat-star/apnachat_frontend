...
import {
  KeyboardBackspace as KeyboardBackspaceIcon,
  Menu as MenuIcon,Done as DoneIcon,Delete as DeleteIcons,Add as AddIcon
} from "@mui/icons-material";
import { useNavigate, useSearchParams } from "react-router-dom";
import { Link } from "../components/styles/StyledComponents";
import AvatarCard from "../components/shared/AvatarCard";
...
//     md:"1rem 4rem"
//   }} >
//     <Button size="large"  color={"error"} startIcon={<DeleteIcons/>} onClick={openConfirmDeleteHandler}>Delete Group </Button>
...
//         bgcolor={"bisque"}
//       >
//          <GroupsList color="black" myGroups={myGroups?.data?.groups} chatId={chatId}/>
...
//         <GroupsList w={"50vw"} color="black" myGroups={myGroups?.data?.groups} chatId={chatId}/>
